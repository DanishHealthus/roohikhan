                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen">{BlogDetails?.author}</Link> </li>
                            ...
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen">facebook</Link></li>
                                        <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen">twitter</Link></li>
                                        <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen">linkedin</Link></li>
                                        <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen"><i className="ti-facebook"></i></Link></li>
                                            <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link to="/blog-single/Justice-May-For-You-If-You-Are-Innocen"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
