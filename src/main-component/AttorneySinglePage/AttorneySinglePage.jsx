            ...
            <div className="attorney-pg-area section-padding">
                <div className="container">
                    <div className="attorney-single-wrap">
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-7">
                                    <div className="attorney-info-text">
                                        ...
                                        <ul>
                                            <li>Position: <span>{AttorneyDetails.title}</span></li>
                        ...
                        <div className="attorney-exprience-area attorney-widget">
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div className="education-area">
                                        ...
                                        <ul>
                                            ...
                                            <li>Admization Institute of Law andTechnology, Juzment School of
                                                Management,Cambridge</li>
                                            <li>The Syntify High School Of New York</li>
                                            <li>Education & Court Admissions</li>
                                            <li>Admization Institute of Law andTechnology, Juzment
                                            ...
                                            <div className="wpo-skill-section">
                                                <div className="wpo-skill-progress">
                                                    <div className="wpo-progress-single">
                                                        <h5 className="progress-title">Business Law</h5>
                                                    ...
                                                    <div className="wpo-progress-single">
                                                        <h5 className="progress-title">Family Law</h5>
                                                        <div className="progress">
                                                            <div className="progress-bar"
                                                    ...
                                                    <div className="wpo-progress-single">
                                                        <h5 className="progress-title">Personal Injury</h5>
                                                        <div className="progress">
                                                            <div className="progress-bar"
                                                    ...
                                                    <div className="wpo-progress-single">
                                                        <h5 className="progress-title">Criminal Law</h5>
                                                        <div className="progress">
                                                            <div className="progress-bar"
                                    ...
                                    <div className="col-lg-6">
                                        <div className="education-area ex-wiget">
                                            ...
                                            <ul>
                                                ...
                                                <li>Young star Award at criminal law in 2021</li>
